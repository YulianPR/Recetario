...
<body>
  ...
  <!-- Ocaciones -->
  <div id="category-carousel" class="carousel multiple-item-carousel" data-bs-ride="false" data-bs-interval="false"
    data-bs-pause="true">
        ...
        <div class="row pie m-0">
          ...
          <div class="col d-flex flex-column align-items-start mb-2 px-4">
            ...
            <div class="row gap-3 list-unstyled align-self-end">
              <div class="col-1"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
