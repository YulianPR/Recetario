...
<body>
  <header class="container p-0">
    <!-- nav menu -->
    <nav class="nav-bar navbar navbar-expand-xxl">
      <div class="col flex-sm-column footer-img-container">
        <a>
          <img class="logo footer-img" src="./img/logob.png" alt="">
        </a>
      </div>
      <div class="mobile-bar">
        <div id="navbar-main" class="mobile-offcanvas">
          <ul class="navbar-nav align-items-center">
            ...
            <li class="nav-item">
              <a class="nav-link" href="#seccion-tips">Tips</a>
            </li>
          </ul>
        </div>
      </div>
      <div class="row flex-sm-column-reverse">
        <div class="col-4">
          <img src="./img/lupa.png" alt="" class="mobile-icon">
        </div>
        <div class="col-4"> 
          <img src="./img/menu.png" alt="" class="mobile-icon">
        </div>       
      </div>
    </nav>
      ...
      <div class="col-md">
        ...
        <div class="row">
          <div class="col">
            ...
            <h5>Nombre de receta</h5>
            <p>Loremm ipsum dolor sit amet consectetur adipisicing elit. Quam, voluptatum.</p>
          </div>
          <div class="col">
            <img
              src="./img/fotos/big-sandwich-hamburger-with-juicy-beef-burger-cheese-tomato-and-red-onion-on-wooden-table.jpg"
  ...
  <section>
    ...
    <div class="container">
      <h3 class="text-start" id="seccion-tips">Algunos tips de interes</h3>
      <div class="row">
        <div class="col-6">
          <img src="./img/fotos/baked-chicken-wings-in-the-asian-style.jpg" class="img-fluid" alt="...">
          <h5>Pollo al horno</h5>
  ...
  <!-- pie de pagina con logo y redes sociales -->
    ...
    <div class="container p-0">
      <div class="row pie m-0">
        ...
        <div class="col d-flex flex-column align-items-start mb-2 px-4">
          <h3>Siguenos en:</h3>
          <div class="row gap-3 list-unstyled align-self-end">           
            <div class="col-1"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
              <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"/>
            </svg></div>
            <div class="col-1"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-twitter" viewBox="0 0 16 16">
              <path d="M5.026 15c6.038 0 9.341-5.003 9.341-9.334 0-.14 0-.282-.006-.422A6.685 6.685 0 0 0 16 3.542a6.658 6.658 0 0 1-1.889.518 3.301 3.301 0 0 0 1.447-1.817 6.533 6.533 0 0 1-2.087.793A3.286 3.286 0 0 0 7.875 6.03a9.325 9.325 0 0 1-6.767-3.429 3.289 3.289 0 0 0 1.018 4.382A3.323 3.323 0 0 1 .64 6.575v.045a3.288 3.288 0 0 0 2.632 3.218 3.203 3.203 0 0 1-.865.115 3.23 3.23 0 0 1-.614-.057 3.283 3.283 0 0 0 3.067 2.277A6.588 6.588 0 0 1 .78 13.58a6.32 6.32 0 0 1-.78-.045A9.344 9.344 0 0 0 5.026 15z"/>
            </svg></div>
            <div class="col-1"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
