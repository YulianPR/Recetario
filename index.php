  ...
  <div id="food-carousel" class="carousel slide mt-2 " data-bs-ride="false" data-bs-interval="false">
    ...
    <div class="carousel-inner">
      ...
      <!-- <div class="carousel-item">
        <img
          src="./img/fotos/big-sandwich-hamburger-with-juicy-beef-burger-cheese-tomato-and-red-onion-on-wooden-table-min.jpg"
          class="d-block w-100 img-photo" alt="...">
        <div class="carousel-caption d-md-block">
          <h6>Second slide label</h6>
        </div>
      </div>
      <div class="carousel-item">
        <img src="./img/fotos/mexican-tacos-with-beef-in-tomato-sauce-and-salsa-min.jpg" class="d-block w-100 img-photo"
          alt="">
        <div class="carousel-caption d-md-block">
