...
-- Dumping structure for table recipes_db.tb_occasion
CREATE TABLE IF NOT EXISTS `tb_occasion` (
  `id_recicpe_occasion` int NOT NULL AUTO_INCREMENT,
  `recipe_occasion` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  PRIMARY KEY (`id_recicpe_occasion`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Dumping data for table recipes_db.tb_occasion: ~6 rows (approximately)
DELETE FROM `tb_occasion`;
/*!40000 ALTER TABLE `tb_occasion` DISABLE KEYS */;
INSERT INTO `tb_occasion` (`id_recicpe_occasion`, `recipe_occasion`) VALUES
	(1, 'Cumpleaños'),
	(2, 'Dia del padre'),
	(3, 'Dia de la madre'),
	(4, 'Dia del niño'),
	(5, 'Navidad'),
	(6, 'Verano');
/*!40000 ALTER TABLE `tb_occasion` ENABLE KEYS */;
...
CREATE TABLE IF NOT EXISTS `tb_recipes` (
  ...
  `recipe_occasion_id` int NOT NULL DEFAULT '0',
  PRIMARY KEY (`id_recipe`),
  KEY `FK_category` (`recipe_category_id`),
  KEY `FK_complex` (`recipe_complex_id`),
  KEY `FK_occasion` (`recipe_occasion_id`),
  ...
  CONSTRAINT `FK_occasion` FOREIGN KEY (`recipe_occasion_id`) REFERENCES `tb_occasion` (`id_recicpe_occasion`)
...
-- Dumping data for table recipes_db.tb_recipes_complex: ~4 rows (approximately)
...
-- Dumping data for table recipes_db.tb_users: ~1 rows (approximately)
